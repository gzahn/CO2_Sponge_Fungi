...
# itsxpress <- "for i in ./seqs/fastqs/*R1_001.fastq.gz; do itsxpress --fastq $i  --outfile $i.FungalITS1.fastq.gz --region ITS1 --taxa Fungi -s --threads 4 --log $i.ITSx.log; done"
